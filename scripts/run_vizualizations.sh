...
for airport in "${airports[@]}"; do
    ...
    python amelia_scenes/viz_scenes.py --traj_version a42v99percentile --graph_version a42v01os --perc 1.0 --scene_type gif  --dpi 3000 --airport ${airport_name} --show-scores --viz_scene ${scene} --scene_id ${scene_id} --to_scale
done
